...
class GameActivity : AppCompatActivity() {
    ...
    private fun dueloUmVsDois(maoUsuario: JogadasMao?, bot1: JogadasMao, bot2: JogadasMao):Any {
        return when {
            ...
            maoUsuario == JogadasMao.PEDRA && bot1 == JogadasMao.PEDRA && bot2 == JogadasMao.TESOURA-> exibirResultado("empate", null)
            maoUsuario == JogadasMao.PEDRA && bot1 == JogadasMao.TESOURA && bot2 == JogadasMao.PEDRA-> exibirResultado("empate", null)
            maoUsuario == JogadasMao.TESOURA && bot1 == JogadasMao.TESOURA && bot2 == JogadasMao.PAPEL-> exibirResultado("empate", null)
            maoUsuario == JogadasMao.TESOURA && bot1 == JogadasMao.PAPEL && bot2 == JogadasMao.TESOURA-> exibirResultado("empate", null)
            maoUsuario == JogadasMao.PAPEL && bot1 == JogadasMao.PAPEL && bot2 == JogadasMao.PEDRA-> exibirResultado("empate", null)
            maoUsuario == JogadasMao.PAPEL && bot1 == JogadasMao.PEDRA && bot2 == JogadasMao.PAPEL-> exibirResultado("empate", null)
            maoUsuario != bot1 && maoUsuario != bot2 && bot1 != bot2 -> exibirResultado("empate",null)

            // SÓ VITÓRIAS
            maoUsuario == JogadasMao.PAPEL && bot1 == JogadasMao.PEDRA && bot2 == JogadasMao.PEDRA-> exibirResultado("vitória", null)
            maoUsuario == JogadasMao.PEDRA && bot1 == JogadasMao.TESOURA && bot2 == JogadasMao.TESOURA-> exibirResultado("vitória", null)
            maoUsuario == JogadasMao.TESOURA && bot1 == JogadasMao.PAPEL && bot2 == JogadasMao.PAPEL-> exibirResultado("vitória", null)

            // SÓ DERROTAS
            maoUsuario == JogadasMao.TESOURA && bot1 == JogadasMao.TESOURA && bot2 == JogadasMao.PEDRA-> exibirResultado("derrota", null)
            maoUsuario == JogadasMao.TESOURA && bot1 == JogadasMao.PEDRA && bot2 == JogadasMao.TESOURA-> exibirResultado("derrota", null)
            maoUsuario == JogadasMao.PAPEL && bot1 == JogadasMao.PAPEL && bot2 == JogadasMao.TESOURA-> exibirResultado("derrota", null)
            maoUsuario == JogadasMao.PAPEL && bot1 == JogadasMao.TESOURA && bot2 == JogadasMao.PAPEL-> exibirResultado("derrota", null)
            maoUsuario == JogadasMao.PEDRA && bot1 == JogadasMao.PEDRA && bot2 == JogadasMao.PAPEL-> exibirResultado("derrota", null)
            maoUsuario == JogadasMao.PEDRA && bot1 == JogadasMao.PAPEL && bot2 == JogadasMao.PEDRA-> exibirResultado("derrota", null)
            else -> exibirResultado("derrota", null)
        }
